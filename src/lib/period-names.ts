...
// Period naming and ordering, with no database access, so the rules that
// decide what "the next period" is are testable on their own
// (scripts/test-core-rules.ts). src/lib/periods.ts re-exports all of it
// alongside the functions that do touch the database.
